            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="street_name" type="text"
                                    ...
                                    value="{{ old('street_name') }}" required autocomplete="street_name">
                        ...
                        <div class="form-group row">
                            <label for="street_num" class="col-md-4 col-form-label text-md-right">Street
                                Number</label>

                            <div class="col-md-6">
                                <input id="street_num" type="text"
                                    class="form-control @error('street_num') is-invalid @enderror" name="street_num"
                                    value="{{ old('street_num') }}" required autocomplete="street_num">
